...
<html lang="en">
    ...
    <head>
        ...
        <title> Todas las Carpetas y Sedes   </title>
        ...
        <meta name="description" content="Carpeta: Todas las Carpetas y Sedes">
        <!-- Google / Search Engine Tags -->
        <meta itemprop="name" content="Carpeta: Todas las Carpetas y Sedes">
        <meta itemprop="description" content="Carpeta: Todas las Carpetas y Sedes">
        <meta itemprop="image" content="{{asset('img/logo_wisi.png')}}">
        <!-- Facebook Meta Tags -->
        <meta property="og:url" content="www.casinosroraima.com">
        <meta property="og:type" content="website">
        <meta property="og:title" content="Carpeta: Todas las Carpetas y Sedes">
        <meta property="og:description" content="Carpeta: Todas las Carpetas y Sedes">
        <meta property="og:image" content="{{asset('img/logo_wisi.png')}}">
        <!-- Twitter Meta Tags -->
        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:title" content="Carpeta: Todas las Carpetas y Sedes">
        <meta name="twitter:description" content="Carpeta: Todas las Carpetas y Sedes">
