...
<div class="panel panel-inverse" data-sortable-id="table-basic-1">
    <div class="panel-heading ui-sortable-handle">
        ...
        <div class="panel-heading-btn">
            <button onclick="pdfExport('associated_machines')" class="d-flex btn btn-1 btn-secondary mx-1">
                <i class="m-auto fas fa-lg fa-file-pdf"></i>
            </button>
            <button onclick="excelExport('associated_machines')" class="d-flex btn btn-1 btn-secondary mx-1">
...
<script>
    ...
    function guardar(id) {
        ...
        if(validity){
            ...
            $.ajax({
                url: "{{ route('associated_machines.store') }}",
                type: "POST",
                data: payload,
    ...
    dataTable("{{route('associated_machines.service')}}",[
        {
        ...
        { data: 'group_name' },
        {
            render: function ( data,type, row  ) {
                return `
                    <a onclick="elim('associated_machines',${row.id})" style="color: var(--global-2)" class="btn btn-danger btn-icon btn-circle"><i class="fa fa-times"></i></a>
