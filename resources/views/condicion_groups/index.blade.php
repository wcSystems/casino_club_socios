...
<div class="panel panel-inverse" data-sortable-id="table-basic-1">
    <div class="panel-heading ui-sortable-handle">
        ...
        <div class="panel-heading-btn">
            <button onclick="pdfExport('condicion_groups')" class="d-flex btn btn-1 btn-secondary mx-1">
                <i class="m-auto fas fa-lg fa-file-pdf"></i>
            </button>
            <button onclick="excelExport('condicion_groups')" class="d-flex btn btn-1 btn-secondary mx-1">
...
@section('js')
<script>
    $('#condicion_groups_nav').removeClass("closed").addClass("active").addClass("expand")
    function modal(type,id) {
        ...
        if(id){
            let current={!! $condicion_groups !!}.find(i=>i.id===id)
    ...
    function guardar(id) {
        ...
        if(validity){
            ...
            $.ajax({
                url: "{{ route('condicion_groups.store') }}",
                type: "POST",
                data: payload,
    ...
    dataTable("{{route('condicion_groups.service')}}",[
        {
        ...
        { data: 'name' },
        {
            render: function ( data,type, row  ) {
                return `
                    <a onclick="elim('condicion_groups',${row.id})" style="color: var(--global-2)" class="btn btn-danger btn-icon btn-circle"><i class="fa fa-times"></i></a>
