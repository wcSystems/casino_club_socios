...
@section('js')
<script>
    $('#horas_casinos_nav').removeClass("closed").addClass("active").addClass("expand")
    function modal(type,id) {
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group row m-b-0">
                                <label class=" text-lg-right col-form-label"> Hora <span class="text-danger"> *</span> </label>
                                <div class="col-lg-12">
                                    <input required type="time" id="name" name="name" class="form-control parsley-normal upper" style="color: var(--global-2) !important" placeholder="Defina la hora aqui..." >
        ...
        if(id){
            let current={!! $horas_casinos !!}.find(i=>i.id===id)
    ...
    dataTable("{{route('horas_casinos.service')}}",[
        {
        ...
        { data: 'sede_name' },
        {
            render: function ( data,type, row  ) {
                return `
                    <a onclick="elim('horas_casinos',${row.id})" style="color: var(--global-2)" class="btn btn-danger btn-icon btn-circle"><i class="fa fa-times"></i></a>
