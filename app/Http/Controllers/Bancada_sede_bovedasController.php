...
use App\Models\Bancada_sede_boveda;

use Illuminate\Http\Request;

class Bancada_sede_bovedasController extends Controller
{
    /**
    ...
    {
        $current_item = Bancada_sede_boveda::updateOrCreate($request->id,$request->data);
        if($current_item){
    ...
    public function fichasBancada($sede_id)
    {
        ...
        $bancada = Bancada_sede_boveda::where('sede_id','LIKE','%'.$sede_id.'%')->get();
