...
class Fichas_casinosController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('fichas_casinos.index')->with('fichas_casinos',$fichas_casinos)->with('sedes',$sedes);
    }
    ...
    {
        $current_item = Fichas_casino::updateOrCreate($request["id"],$request["data"]);
        if($current_item){
    ...
    {
        $current_item = Fichas_casino::find($id);
        if($current_item){
            $current_item->delete();
            return response()->json([ 'type' => 'success']);
        }else{
    ...
    public function service(Request $request)
    {
        ...
        $totalRecords = count(Fichas_casino::all());
