...
use App\Models\Conteo_drop_boveda_casino;
use Illuminate\Support\Facades\DB;

use Illuminate\Http\Request;

class Conteo_drop_boveda_casinosController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        $current_item = Conteo_drop_boveda_casino::updateOrCreate($request->id,$request->data);
        if($current_item){
    ...
    public function list(Request $request)
    {
                        ...
                        $list = DB::table('conteo_drop_boveda_casinos')
