...
class Group_archings_casinosController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('group_archings_casinos.index')
    ...
    {
        $current_item = Group_archings_casino::updateOrCreate($request["id"],$request["data"]);
        if($current_item){
    ...
    public function destroy($id)
    {
        ...
        $current_item = Group_archings_casino::find($id);
        if($current_item){
            $current_item->delete();
            return response()->json([ 'type' => 'success']);
        }else{
    ...
    public function service(Request $request)
    {
        ...
        /* QUERY FILTER */
        $query = DB::table('group_archings_casinos')
                    ->selectRaw('group_archings_casinos.*, sedes.id AS sede_id, sedes.name AS sede_name, sedes.name AS group_name')
                    ->join('sedes', 'group_archings_casinos.sede_id', '=', 'sedes.id')
                    ->orderBy('group_archings_casinos.created_at', 'desc')
                    ->get();
        ...
        $totalRecords = count(Group_archings_casino::all());
