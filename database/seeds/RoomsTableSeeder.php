...
class RoomsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('rooms')->insert([ 'group' => "2", 'name' => "Gainer’s", 'address' => "Calle Carabobo # 12 puerto la Cruz" ]);
        DB::table('rooms')->insert([ 'group' => "2", 'name' => "Barrio sucre", 'address' => "Calle Guayaquil # 11-14 barrio sucre Barcelona" ]);
        DB::table('rooms')->insert([ 'group' => "2", 'name' => "Mesones ( cerca de SIGO )", 'address' => "Centro comercial Mezfari, galpón # 11 calle san Antonio, barrio pequeña y mediana industria, mesones, parroquia san Cristóbal, Barcelona estado Anzoátegui, 6001" ]);
        DB::table('rooms')->insert([ 'group' => "2", 'name' => "Edi", 'address' => "S/D" ]);
        DB::table('rooms')->insert([ 'group' => "2", 'name' => "Bolivar", 'address' => "S/D" ]);
    }
}
