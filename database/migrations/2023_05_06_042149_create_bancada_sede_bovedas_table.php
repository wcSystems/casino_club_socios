...
class CreateBancadaSedeBovedasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bancada_sede_bovedas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('bancada_sede_bovedas');
    }
}
